...
@testset "Testing reorder_fast" begin
    function repeated_reorder(verts1, verts2, strat)
        for i in 1:1000000
            I, j = SauterSchwabQuadrature.reorder_fast(verts1, verts2, strat)
        end
    end
    ...
    I2, J2 = SauterSchwabQuadrature.reorder_fast(verts1, verts2, CommonVertex(1))
    ...
    I2, J2 = SauterSchwabQuadrature.reorder_fast(verts1, verts2, CommonEdge(1))
    @test prod(I1 .== I2) * prod(J1 .== J2) == 1
    ...
    I2, J2 = SauterSchwabQuadrature.reorder_fast(verts1, verts2, CommonFace(1))
    @test prod(I1 .== I2) * prod(J1 .== J2) == 1
